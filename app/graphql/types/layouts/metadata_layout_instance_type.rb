...
module Types
  module Layouts
    ...
    class MetadataLayoutInstanceType < ::Types::BaseModel
      ...
      field :templates, [Types::AnyMetadataTemplateInstanceType, { null: false }], null: false do
        description <<~TEXT
        The ordered template instances available for this layout.
        TEXT
      end

      field :template, "Types::Templates::MetadataTemplateInstanceType", null: true do
        description <<~TEXT
      ...
      ::Layouts::MetadataInstance.template_instance_names.each do |name|

...
module Templates
  module Tags
    ...
    class ParsedArgs
      ...
      # @return [Templates::Tags::ParsedArg, nil]
      ...
      # @see Templates::Tags::ParsedArg#evaluate_asset
      # @param [Symbol, Integer] index_or_name
      # @return [Asset, nil]
      ...
      # @see Templates::Tags::ParsedArg#evaluate_entity
      # @param [Symbol, Integer] index_or_name
      ...
      # @see Templates::Tags::ParsedArg#evaluate
      # @param [Symbol, Integer] index_or_name
      # @return [Object, nil]
      ...
      # @return [{ Symbol => Templates::Tags::ParsedArg }]
      attr_reader :args

      # @return [<Templates::Tags::ParsedArg>]
      ...
      def parse_kwarg!(name, expression)
        ...
        arg = Templates::Tags::ParsedArg.new(value:, expression:, name:, kwarg: true)
      ...
      def parse_positional_arg!(expression)
        ...
        arg = Templates::Tags::ParsedArg.new(value:, expression:, name:, index:)

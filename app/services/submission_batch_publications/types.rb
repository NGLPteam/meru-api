...
module SubmissionBatchPublications
  # Types for working with {SubmissionBatchPublication} operations and services.
  module Types
    ...
    State = ApplicationRecord.dry_pg_enum("submission_batch_publication_state", default: "pending")

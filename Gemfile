...
gem "graphql-fragment_cache", "~> 1.22"
gem "search_object_graphql", "~> 1.0", require: %w[search_object search_object/plugin/graphql]
...
gem "sinatra-contrib", "~> 4.2", require: false
gem "statesman", "~> 13.1"
...
group :development, :test do
  ...
  gem "yard-activerecord", "~> 0.0", require: false
  gem "yard-activesupport-concern", "~> 0.0", require: false
end
